...
public class Map3 extends Map{
    Map3(){
        ...
        gameObjects.add(new Land(44, 46,0 ,-0.5));
        gameObjects.add(new Land(47, 51,3.5 ,3));
        gameObjects.add(new Land(51, 53,0 ,-0.5));
