...
public class Header{
    public static void drawHeader(BufferedImage image, int timeLeft, int lives, Powerup power){
        ...
        graphics.drawString("Lives: "+ lives, 250,22);
        graphics.drawString("Powerup: "+ power.getName(), 570,22);
    }
}